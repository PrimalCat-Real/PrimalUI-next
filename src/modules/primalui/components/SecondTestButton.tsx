...
const SecondTestButton = () => {
    const buttonName = "TestButton2"
    return (
        <button aria-label={buttonName} className={cn('px-4 py-2 inline-flex font-medium items-center gap-x-2 group border-blue-400/40 border rounded-md cursor-pointer relative overflow-hidden shiny-border shiny-border-spin',
...
export default SecondTestButton